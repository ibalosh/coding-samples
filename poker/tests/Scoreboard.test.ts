...
describe('Scoreboard', () => {
  let defaultMatchHandler: MatchesHandler;

  beforeEach(() => {
    defaultMatchHandler = new MatchesHandler();
  })
  ...
  it('start a new game', () => {
    const scoreboard = new Scoreboard(new MatchesHandler());
  ...
  it('finish an existing game', () => {
    ...
    expect(scoreboard.showMatches().length).toBe(1);
  })
